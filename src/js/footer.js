        ...
        <div class="container">
            <div class="footer-row">
                ...
                <div class="footer-brand">
                    ...
                    <a class="icon-link" href="https://www.instagram.com/laplacitacolombiana_2025/">
                    ...
                    <a class="icon-link" href="https://x.com/CPlacita59475">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter-x" viewBox="0 0 16 16">
                            <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865z"/>
                                </svg>
                    </a>
                    <a class="icon-link" href="https://www.tiktok.com/@colombianalaplacita">
                ...
                <div class="foo-bottom">
                    <p>© 2025 La Placita Colombiana — Todos los derechos reservados.</p>
                    <a href="#top" class="back-top" aria-label="Volver arriba">↑ Volver arriba</a>
                </div>
            </div>
        </div>
    </footer>
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (footerContainer) {
        footerContainer.innerHTML = mostrarFooter();
    }
});
